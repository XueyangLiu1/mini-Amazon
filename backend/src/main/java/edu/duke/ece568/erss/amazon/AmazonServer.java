...
public class AmazonServer {
    ...
    public static final String WORLD_HOST_IP = "vcm-18471.vm.duke.edu";
    ...
    public boolean amazonToWorldConnection(long worldId, boolean reconnect) throws IOException {
        System.out.println("Connecting to world at ("+WORLD_HOST_IP+", "+AMAZON_PORTNUM+")");
    ...
    public newShipment getNewShipment(AProduct p, warehouse w, Package pac, long shipId){
        ...
        newShip.setUpsUsername(pac.getUpsUsername());
        long seq = seqNumGenerator();
